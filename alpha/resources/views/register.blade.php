...
<body>
  <style>
    ...
    <div class="darkmodebutton"><a href="{{url('darkregister')}}" class="sunicon">&#9728;</a></div>
  ...
  <div class="grid">
    ...
    <p class="text--center">Imate račun? <a href="{{url('/')}}" class="edit003">Prijavi se</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
